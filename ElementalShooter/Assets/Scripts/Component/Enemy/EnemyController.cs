...
public class EnemyController : MonoBehaviour, IPoolable, IStatProvider
{
    ...
    private void Awake()
    {
        ...
        // Thiết lập tối ưu hóa Rigidbody2D vật lý (Dùng Kinematic để nhận Trigger nhưng không tính toán va chạm)
        ...
        _components = GetComponentsInChildren<IEnemyComponent>();
